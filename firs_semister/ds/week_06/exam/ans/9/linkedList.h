...
*/
    ...
    int search_by_position(int pos1)
    {
        if (pos1 == 0)
        {
            return 1;
    ...
    Node<DT> *search_by_position_return_node(DT value)
    {
        // Node<DT> c;
